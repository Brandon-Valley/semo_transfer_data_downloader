...
from semo_transfer_data_downloader.scrape_html._download_all_equiv_child_pages_of_inst_page import (
...
def _click_inst_page_num(driver, page_num):
    ...
    if page_num in DOT_DOT_DOT_INST_PAGE_NUMS:
        link = driver.find_element(
            By.XPATH, f"//a[@href=\"javascript:__doPostBack('gdvInstWithEQ','Page${page_num}')\"]"
        )
    else:
